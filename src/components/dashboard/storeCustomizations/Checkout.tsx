  ...
  const form = useForm<CheckoutFormValues>({
    ...
    defaultValues: {
      ...
      shippingDetails: {
        ...
        shippingCost: 0,
        shippingOneName: "",
        shippingOneDescription: "",
        shippingOneCost: 0,
        shippingTwoName: "",
        shippingTwoDescription: "",
        shippingTwoCost: 0,
        paymentMethod: "",
        continueButton: "",
        confirmButton: "",
        ...
        <form onSubmit={form.handleSubmit(submit)}>
          ...
          <section className="mb-6 grid-cols-1 sm:grid-cols-3 grid md:grid-cols-5 gap-3">
            ...
            <Controller
              ...
              control={form.control}
              render={({ field }) => (
                <Input {...field} placeholder="Shipping Option 1 Description" />
              )}
            />
            <Controller
            ...
            <Controller
              ...
              control={form.control}
              render={({ field }) => (
                <Input {...field} placeholder="Shipping Option 2 Description" />
              )}
            />
            <Controller
